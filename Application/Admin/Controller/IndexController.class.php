...
class IndexController extends AdminController
{
	...
	'pid' => array('neq', 0)
			...
			if ($list[1]) {
				...
				M('Menu')->add(array('url' => 'Index/coin', 'title' => '币种统计', 'pid' => 1, 'sort' => 2, 'hide' => 1, 'group' => '系统', 'ico_name' => 'home'));
			}
			else {
				M('Menu')->where(array('url' => 'Index/coin'))->save(array('title' => '币种统计', 'pid' => 1, 'sort' => 2, 'hide' => 1, 'group' => '系统', 'ico_name' => 'home'));
			}
			...
			M('Menu')->where(array('id' => 10))->save(array('title' => '扩展', 'url' => 'Cloud/index', 'pid' => 0, 'sort' => 1, 'hide' => 1, 'group' => '', 'ico_name' => 'tasks'));

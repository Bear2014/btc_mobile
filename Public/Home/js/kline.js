        ...
        function() {
            ...
            $(function() {
                ...
                function Ii(n, e) {
                    var r, o, i, u, a;
                    return a = ar[n],
                    (null != a ? a.tid: void 0) > e.tid || (i = $(t.tr + n), 0 === i.length) ? void 0 : (u = parseFloat(i.text()), r = parseFloat(e.last), o = -1 !== n.indexOf(t.RA) ? t.ZG + (r / $c_CNYcny).toFixed(2) + t.oi + r.toString() : r.toString(), i.html(o), ar[n] = e)
                }
                function Oi(n) {
